...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        if (!docImg || !name || !email || !password || !fees || !street || !city || !state || !pincode) {
        ...
        try {
            ...
            formData.append('fees', Number(fees)); // Ensure it's a number
        ...
        <form onSubmit={onSubmitHandler} className="m-5 w-full">
            ...
            <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
                <div className="flex items-center gap-4 mb-8 text-gray-500">
                    ...
                    <p>Upload LAb <br /> picture</p>
                </div>

                <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
                    <div className="w-full lg:flex-1 flex flex-col gap-4">
                        <div className="flex-1 flex flex-col gap-1">
                            <p>Techniciasn name</p>
                    ...
                    <div className="w-full lg:flex-1 flex flex-col gap-4">
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                            <p>Street</p>
                            <input onChange={e => setStreet(e.target.value)} value={street} className="border rounded px-3 py-2" type="text" placeholder="Street" required />
                        </div>
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                            <p>Pincode</p>
                            <input onChange={e => setPincode(e.target.value)} value={pincode} className="border rounded px-3 py-2" type="text" placeholder="Pincode" required />
                        </div>
                    </div>
                </div>

                <div>
                    <p className="mt-4 mb-2">About Techniciasn</p>
                    <textarea onChange={e => setAbout(e.target.value)} value={about} className="w-full px-4 pt-2 border rounded" rows={5} placeholder="write about techniciasn"></textarea>
                </div>
